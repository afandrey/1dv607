...
namespace BlackJack.view
{
    public class SwedishView : IView
    {
        public void DisplayWelcomeMessage()
        {
            ...
            System.Console.Write("Skriv '" + (char)MenuOptions.PLAY + "' för att Spela, '");
            System.Console.Write((char)MenuOptions.HIT + "' för nytt kort, '");
            System.Console.Write((char)MenuOptions.STAND + "' för att stanna '");
            System.Console.Write((char)MenuOptions.QUIT + "' för att avsluta\n");
            System.Console.WriteLine();
        }
